...
inline __device__ void sh_coeffs_to_color_fast(
    ...
    if (degree >= 1) {
        ...
        if (degree >= 2) {
            ...
            T fTmp0B = -1.092548430592079f * y;
            T fC1 = z2 - x2;
            T fS1 = 2.f * zx;
            T pSH6 = (0.9461746957575601f * y2 - 0.3153915652525201f);
            T pSH7 = fTmp0B * z;
            T pSH5 = fTmp0B * x;
            T pSH8 = 0.5462742152960395f * fC1;
            T pSH4 = 0.5462742152960395f * fS1;
            ...
            result += pSH4 * coeffs[4 * 3 + c] + pSH5 * coeffs[5 * 3 + c] +
                      ...
                      pSH8 * coeffs[8 * 3 + c];
            if (degree >= 3) {
                T fTmp0C = -2.285228997322329f * y2 + 0.4570457994644658f;
                T fTmp1B = 1.445305721320277f * y;
                T fC2 = z * fC1 - x * fS1;
                T fS2 = z * fS1 + x * fC1;
                T pSH12 = y * (1.865881662950577f * y2 - 1.119528997770346f);
                T pSH13 = fTmp0C * z;
                T pSH11 = fTmp0C * x;
                T pSH14 = fTmp1B * fC1;
                T pSH10 = fTmp1B * fS1;
                ...
                if (degree >= 4) {
                    ...
                    T fTmp1C = 3.31161143515146f * y2 - 0.47308734787878f;
                    T fTmp2B = -1.770130769779931f * y;
                    T fC3 = z * fC2 - x * fS2;
                    T fS3 = z * fS2 + x * fC2;
                    T pSH20 =
...
inline __device__ void sh_coeffs_to_color_fast_vjp(
    ...
    T fTmp0D = y * (-4.683325804901025f * y2 + 2.007139630671868f);
    T fTmp1C = 3.31161143515146f * y2 - 0.47308734787878f;
    T fTmp2B = -1.770130769779931f * y;
    T fC3 = z * fC2 - x * fS2;
    T fS3 = z * fS2 + x * fC2;
    T pSH20 = (1.984313483298443f * y * pSH12 + -1.006230589874905f * pSH6);
    T pSH21 = fTmp0D * z;
    T pSH19 = fTmp0D * x;
    T pSH22 = fTmp1C * fC1;
    T pSH18 = fTmp1C * fS1;
